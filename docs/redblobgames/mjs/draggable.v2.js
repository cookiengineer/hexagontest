...
export class Draggable {
     ...
     *
     * el: HTMLElement | String - required - the element where the drag handlers are attached
     ...
     * TODO: optionally install a mouseover handler that transforms coordinates
     * TODO: optionally rescale to canvas coordinates, like we do for svg
     */
    constructor(props) {
        if (typeof props.el === 'string') { props.el = document.querySelector(props.el); }
